...
for data in list_buku: bst_buku.insert(Buku(*data))

list_mahasiswa = [
    ("251011001", "Ahmad Fauzi", "Ilmu Komputer", 2025),
    ("251011002", "Budi Santoso", "Sistem Informasi", 2025),
    ("251011003", "Citra Dewi", "Teknik Informatika", 2024),
    ("251011004", "Dian Pertiwi", "Ilmu Komputer", 2025),
    ("251011005", "Eko Prasetyo", "Sistem Informasi", 2024),
    ("251011006", "Fitri Handayani", "Teknik Informatika", 2025),
    ("251011007", "Gunawan Saputra", "Ilmu Komputer", 2024),
    ("251011008", "Hani Rahayu", "Sistem Informasi", 2025),
    ("251011009", "Irfan Maulana", "Teknik Informatika", 2024),
    ("251011010", "Joko Susanto", "Ilmu Komputer", 2025),
    ("251011011", "Kartini Sari", "Sistem Informasi", 2024),
    ("251011012", "Lukman Hakim", "Teknik Informatika", 2025),
    ("251011013", "Maya Lestari", "Ilmu Komputer", 2024),
    ("251011014", "Nanda Wijaya", "Sistem Informasi", 2025),
    ("251011015", "Omar Hidayat", "Teknik Informatika", 2024),
    ("251011016", "Putri Ayu", "Ilmu Komputer", 2025),
    ("251011017", "Reza Kusuma", "Sistem Informasi", 2024),
    ("251011018", "Sari Pratama", "Teknik Informatika", 2025),
    ("251011019", "Toni Putra", "Ilmu Komputer", 2024),
    ("251011020", "Umar Halim", "Sistem Informasi", 2025),
    ("251011021", "Vera Puspita", "Teknik Informatika", 2024),
    ("251011022", "Wahyu Setiawan", "Ilmu Komputer", 2025),
    ("251011023", "Xena Ananda", "Sistem Informasi", 2024),
    ("251011024", "Yudi Ramadan", "Teknik Informatika", 2025),
    ("251011025", "Zara Maharani", "Ilmu Komputer", 2024),
    ("251011026", "Andi Saputra", "Sistem Informasi", 2025),
    ("251011027", "Bagas Pratama", "Teknik Informatika", 2024),
    ("251011028", "Chika Lestari", "Ilmu Komputer", 2025),
    ("251011029", "Dafa Wijaya", "Sistem Informasi", 2024),
    ("251011030", "Elsa Puspita", "Teknik Informatika", 2025),
    ("251011031", "Farhan Hakim", "Ilmu Komputer", 2024),
    ("251011032", "Gita Ayu", "Sistem Informasi", 2025),
    ("251011033", "Hendra Setiawan", "Teknik Informatika", 2024),
    ("251011034", "Ika Sari", "Ilmu Komputer", 2025),
    ("251011035", "Johan Maulana", "Sistem Informasi", 2024),
    ("251011036", "Krisna Hidayat", "Teknik Informatika", 2025),
    ("251011037", "Laras Pertiwi", "Ilmu Komputer", 2024),
    ("251011038", "Miko Prasetyo", "Sistem Informasi", 2025),
    ("251011039", "Nina Handayani", "Teknik Informatika", 2024),
    ("251011040", "Oscar Halim", "Ilmu Komputer", 2025),
    ("251011041", "Aldo Santoso", "Sistem Informasi", 2024),
    ("251011042", "Bela Dewi", "Teknik Informatika", 2025),
    ("251011043", "Cahyo Saputra", "Ilmu Komputer", 2024),
    ("251011044", "Deni Rahayu", "Sistem Informasi", 2025),
    ("251011045", "Evi Lestari", "Teknik Informatika", 2024),
    ("251011046", "Fajar Wijaya", "Ilmu Komputer", 2025),
    ("251011047", "Gilang Kusuma", "Sistem Informasi", 2024),
    ("251011048", "Hafiz Pratama", "Teknik Informatika", 2025),
    ("251011049", "Indah Puspita", "Ilmu Komputer", 2024),
    ("251011050", "Jamil Setiawan", "Sistem Informasi", 2025),
    ("251011051", "Kevin Ananda", "Teknik Informatika", 2024),
    ("251011052", "Lia Maharani", "Ilmu Komputer", 2025),
    ("251011053", "Maman Ramadan", "Sistem Informasi", 2024),
    ("251011054", "Nia Fauzi", "Teknik Informatika", 2025),
    ("251011055", "Oki Saputra", "Ilmu Komputer", 2024),
    ("251011056", "Panji Santoso", "Sistem Informasi", 2025),
    ("251011057", "Qori Dewi", "Teknik Informatika", 2024),
    ("251011058", "Rafi Pertiwi", "Ilmu Komputer", 2025),
    ("251011059", "Sandi Prasetyo", "Sistem Informasi", 2024),
    ("251011060", "Tari Handayani", "Teknik Informatika", 2025),
    ("251011061", "Ujang Saputra", "Ilmu Komputer", 2024),
    ("251011062", "Vino Rahayu", "Sistem Informasi", 2025),
    ("251011063", "Wira Maulana", "Teknik Informatika", 2024),
    ("251011064", "Yana Sari", "Ilmu Komputer", 2025),
    ("251011065", "Nur Inayah", "Ilmu Komputer", 2025),
    ("251011066", "Agus Hakim", "Teknik Informatika", 2025),
    ("251011067", "Bunga Lestari", "Ilmu Komputer", 2024),
    ("251011068", "Cipto Wijaya", "Sistem Informasi", 2025),
    ("251011069", "Dimas Hidayat", "Teknik Informatika", 2024),
    ("251011070", "Erika Ayu", "Ilmu Komputer", 2025),
    ("251011071", "Fauzan Kusuma", "Sistem Informasi", 2024),
    ("251011072", "Galuh Pratama", "Teknik Informatika", 2025),
    ("251011073", "Hari Putra", "Ilmu Komputer", 2024),
    ("251011074", "Intan Halim", "Sistem Informasi", 2025),
    ("251011075", "Jamal Puspita", "Teknik Informatika", 2024),
    ("251011076", "Kirana Setiawan", "Ilmu Komputer", 2025),
    ("251011077", "Luthfi Ananda", "Sistem Informasi", 2024),
    ("251011078", "Mila Ramadan", "Teknik Informatika", 2025),
    ("251011079", "Niko Maharani", "Ilmu Komputer", 2024),
    ("251011080", "Oman Fauzi", "Sistem Informasi", 2025),
    ("251011081", "Puput Santoso", "Teknik Informatika", 2024),
    ("251011082", "Qosim Dewi", "Ilmu Komputer", 2025),
    ("251011083", "Rina Pertiwi", "Sistem Informasi", 2024),
    ("251011084", "Surya Prasetyo", "Teknik Informatika", 2025),
    ("251011085", "Tita Handayani", "Ilmu Komputer", 2024),
    ("251011086", "Udin Saputra", "Sistem Informasi", 2025),
    ("251011087", "Vivi Rahayu", "Teknik Informatika", 2024),
    ("251011088", "Wawan Maulana", "Ilmu Komputer", 2025),
    ("251011089", "Yoga Sari", "Sistem Informasi", 2024),
    ("251011090", "Zaki Hakim", "Teknik Informatika", 2025),
    ("251011091", "Alya Lestari", "Ilmu Komputer", 2024),
    ("251011092", "Bowo Wijaya", "Sistem Informasi", 2025),
    ("251011093", "Cici Hidayat", "Teknik Informatika", 2024),
    ("251011094", "Dodi Ayu", "Ilmu Komputer", 2025),
    ("251011095", "Endah Kusuma", "Sistem Informasi", 2024),
    ("251011096", "Feri Pratama", "Teknik Informatika", 2025),
    ("251011097", "Gita Putra", "Ilmu Komputer", 2024),
    ("251011098", "Hasan Halim", "Sistem Informasi", 2025),
    ("251011099", "Iqbal Puspita", "Teknik Informatika", 2024),
    ("251011100", "Jihan Setiawan", "Ilmu Komputer", 2025)
]
...
# =============================================================================
# APLIKASI GUI PERPUSTAKAAN (MODERN STYLING)
# =============================================================================
class PerpustakaanGUI:
    def __init__(self, root):
        ...
        header_frame = tk.Frame(root, bg="#1877f2", height=60)
        header_frame.pack(fill="x", side="top")
        header_label = tk.Label(header_frame, text="SISTEM LAYANAN PERPUSTAKAAN ITH", font=("Segoe UI", 16, "bold"), bg="#1877f2", fg="white")
